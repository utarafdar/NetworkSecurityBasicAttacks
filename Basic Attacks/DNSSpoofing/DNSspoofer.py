"""
This script is continuation of sniffing script
here we not only snoop the dns request but also spoof fake dns responses
...
def print_packet(packet):
	...
	set the rdata field in an(answer section) to 94.221.161.165
	so that the DNS requests to fakeme.seclab.cs.bonn.edu. are redirected 
	to our desired IP
    """
